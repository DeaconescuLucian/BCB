...
function setupHandlers(db, solanaConnection, mainProcess, mainWindow) {
    (0, WalletHandler_1.default)(db, solanaConnection);
    (0, ConnectionHandler_1.default)(db, solanaConnection, mainProcess, mainWindow);
    (0, TokenHandler_1.default)(db, solanaConnection);
    (0, TransactionHandler_1.default)(db, solanaConnection, mainProcess, mainWindow);
}
