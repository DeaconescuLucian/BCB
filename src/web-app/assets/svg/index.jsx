...
export const successSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="success_svg" x="0px" y="0px" viewBox="0 0 507.506 507.506">
    <g>
...
export const pendingSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" id="pending_svg" viewBox="0 0 24 24">
...
export const viewSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" id="view_svg" data-name="Layer 1" viewBox="0 0 24 24">
...
export const importWalletSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" id="import_wallet_svg" viewBox="0 0 24 24" width="20" height="20">
...
export const infoSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" id="info_svg" viewBox="0 0 24 24">
